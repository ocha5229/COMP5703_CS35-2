<template>
  <div id="tags-view-container" class="tags-view-container">
    ...
    <ul v-show="visible" :style="{left:left+'px',top:top+'px'}" class="contextmenu">
      <li @click="refreshSelectedTag(selectedTag)"><i class="el-icon-refresh-right"></i> </li>
      <li v-if="!isAffix(selectedTag)" @click="closeSelectedTag(selectedTag)"><i class="el-icon-close"></i> </li>
      <li @click="closeOthersTags"><i class="el-icon-circle-close"></i> </li>
      ...
      <li @click="closeAllTags(selectedTag)"><i class="el-icon-circle-close"></i> </li>
    </ul>
  </div>
</template>
