	...
	<div class="login">
		<el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
			...
			<el-form-item prop="code" v-if="captchaEnabled">
				<el-input v-model="loginForm.code" auto-complete="off" placeholder="Code" style="width: 63%"
					@keyup.enter.native="handleLogin">
			...
			<el-checkbox v-model="loginForm.rememberMe" style="margin:0px 0px 25px 0px;">Remember the
				password</el-checkbox>
			<el-form-item style="width:100%;">
				<el-button :loading="loading" size="medium" style="width:100%;" @click.native.prevent="handleLogin">
					<span v-if="!loading">Log in</span>
					<span v-else>Be logging in...</span>
				</el-button>
